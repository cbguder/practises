...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\practises on
     Windows, /home/user/dev/practises on Linux) in a file named
     practises@cbguder.org and copy that file to
