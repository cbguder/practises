...
namespace PractiSES
{
    class KeyGenerator
    {
        ...
        {            
            ...
            {
                upperBound = KeyGenerator.UBoundDigit;
            }
        ...
        public int Minimum
        {
            ...
            { 
                this.minSize = value;
                if ( KeyGenerator.DefaultMinimum > this.minSize )
                {
                    this.minSize = KeyGenerator.DefaultMinimum;
                }
            }
        }
        ...
        public int Maximum
        {
            ...
            { 
                ...
                {
                    this.maxSize = KeyGenerator.DefaultMaximum;
                }
            }
        }
